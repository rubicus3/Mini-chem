                ...
                <View style={{ alignItems: "center", marginTop: 50 }}>
                    <View style={{ flexDirection: "row", alignItems: "center" }}>
                        ...
                        <View style={{ marginLeft: 20 }}>
                            ...
                            <Text>Атомная масса: {(elementInfo.atomic_mass).toFixed(4)}</Text>
                        </View>
                    </View>
                    <Divider style={{ width: 200, height: 1, marginVertical: 10 }} />
                    ...
                    <Text>Плотность: {Math.round((elementInfo.density) * 1000) / 1000} кг/м3</Text>
                    <Text>Кипение: {Math.round((elementInfo.boil) * 1000) / 1000} K / {Math.round((elementInfo.boil - 273.15) * 1000) / 1000} °C</Text>
                    <Text>Плавление: {Math.round((elementInfo.melt) * 1000) / 1000} K / {Math.round((elementInfo.melt - 273.15) * 1000) / 1000} °C</Text>
                    ...
                    {/* <Text>Энергия сродства к электрону {elementInfo.electron_affinity}</Text> */}


                </View>
            )}

            <Divider style={{ width: "90%", height: 1, marginTop: 40, marginBottom: 10 }} />
